...
#include "globals.h"
 ...
 /* :TODO:Monday, December 01, 2014 11:53:25 HKT:SeanHou:  */
...
void process_requests(int server_s, struct soap *soap);//SeanHou
...
/* select */
void select_loop(int server_s, struct soap* soap);//SeanHou
